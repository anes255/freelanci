...
export default function OrderDetailScreenFreelancer({ route, navigation }) {
  ...
  const handleConfirmPayment = () => {
    ...
    Alert.alert(
      '💰 Confirm Payment',
      `Are you sure you received ${order.price} DA from ${order.clientId?.name || 'the client'}?\n\nThis action cannot be undone.`,
      [
        { 
          text: 'Cancel', 
          style: 'cancel' 
  ...
  const isFreelancer = currentUserId === order.freelancerId?._id;
    ...
    >
      ...
      >
        ...
        <View style={[
          ...
          {/* Confirm Payment Button - Right Side */}
